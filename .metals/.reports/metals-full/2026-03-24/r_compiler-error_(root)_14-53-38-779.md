error id: 47FACC5ADE46A2F321E768F126F73E83
...
case class GameState(board: Board, turn: Stone, rand: MyRandom) {
...
object GameState {
  def initiallizeBoard(rand: MyRandom, width: Int, height: Int):GameState = {
    

    @tailrec
    def loop(row: Int, col: Int, board: Board): Board = row k@@match {
      case 
    }
  }
...
java.base/jdk.internal.util.Preconditions$1.apply(Preconditions.java:55)
	...
	dotty.tools.dotc.interactive.Completion$Completer.extensionCompletions(Completion.scala:589)
	dotty.tools.dotc.interactive.Completion$Completer.selectionCompletions(Completion.scala:478)
	dotty.tools.dotc.interactive.Completion$.computeCompletions(Completion.scala:240)
	...
	dotty.tools.pc.completions.Completions.completions(Completions.scala:144)
